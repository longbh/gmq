...
func (sa *SubackPacket) Write(w io.Writer) error {
	...
	var err error
	body.Write(utils.EncodeUint16(sa.MessageID))
...
func (sa *SubackPacket) Unpack(b io.Reader) error {
	...
	var err error
	sa.MessageID, err = utils.DecodeUint16(b)
	if err != nil {
		return err
	}
...
//header
func (pr *SubackPacket) FixHeader() FixedHeader {
	return pr.FixedHeader
}

func (ca *SubackPacket) Process() ControlPacket {
	return nil
}